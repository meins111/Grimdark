...
In short, the Generalist Path does not track individual [Specialties](SkillSystem/Specialty.md) of a character. Using this playstyle, checks are always resolved using a [Profession Check](</SkillSystem/Profession Check.md>). This leads to a more simplistic gameplay compared to the Specialist Path. 
